 ...
 */
@WebServlet("/ConsultaUsuarioExclusaoServlet")
public class ConsultaUsuarioExclusaoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
 	...
 	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
 		...
 		RequestDispatcher rd = request.getRequestDispatcher("consultaUsuarioExclusao.jsp");
